        ...
        <div className={`${styles["home-hero-text"]} ${"lg:w-[60%] w-full"}`}>
          <div className="header-container">
            ...
            <div>
              ...
              <p><i>How to bridge this?  </i>  I think there needs to a unifying thread between these student organizations. Just as structures for individual accountability are important, large organizations like student clubs can benefit from each other's direction and drive towards building tomorrow's entrepreneurs. I think that Morrissette is perfectly positioned to help achieve this. Morrissette has a wealth of resources for Western entrepreneurs, from advisors to pitch competitions to mentors. The one thing they need more of is exposure to students, which is exactly what these clubs have. A crucial next step for both organizations would be to join forces, where Morrissette provides further resources to these student organizations, while they serve as a funnel directing entrepreneurial potential to the right place to grow.</p>
<br/>
<br/>
<br/>
