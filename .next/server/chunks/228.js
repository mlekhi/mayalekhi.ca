...
const projects = [
    {
        ...
        paragraph: "I have always admired the beauty of human connection in bringing people together. In an effort to increase inclusivity and sprout more meaningful connections, I have set out to make learning sign language more accessible to all. \n\nThis project is a real-time ASL translator that detects hand landmarks using Mediapipe to predict the letter being signed by the user through a Convoluted Neural Network.",
        tags: [
            "AI",
            "Computer Vision",
            "Python"
    ...
    {
        title: "RachelAI",
        description: "Turning Myself into a Talking AI Avatar Upon a Fortune 500 Client’s Request",
        paragraph: "As an innovation consulting agency, Onova doesn't just run hackathons, we compete in them too. When retail and generative AI unite, you get RachelAI: a personalized online shopping assistant. \n\nBuilt with Stable Diffusion, Google Cloud Vertex AI, and speech-to-text and text-to-speech APIs, RachelAI can guide users through everything from shipping policies to individualized product recommendations.",
        tags: [
            "AI",
            "NLP",
            "Stable Diffusion",
        ...
        links: [
            {
                site: "Github",
                url: "https://github.com/onova-dev/rachel-ai"
            },
            {
                site: "Video Demo",
    ...
    },
    {
        ...
        description: "Merging Data Science and Business Strategy to Retain Hotel Customers",
        paragraph: "Faced with the challenge of lowering the rates of hotel booking cancellations, we developed a predicive machine learning model optimized with feature engineering and hyperparameter tuning using Scikit-Learn. With our data analysis and visualization using Pandas, NumPy, Seaborn, and Matplotlib, we found correlations and generated insights to inform our business recommendations.",
        tags: [
            "AI",
            "Data Science",
            "Data Visualization"
